...
public class ObjectFactory {
     ...
     * 
     */
    /*@XmlElementDecl(namespace = "", name = "group", scope = CourseType.class)
    public JAXBElement<GroupType> createCourseTypeGroup(GroupType value) {
        return new JAXBElement<GroupType>(_CourseTypeGroup_QNAME, GroupType.class, CourseType.class, value);
    }*/
     ...
     * 
     */
    /*@XmlElementDecl(namespace = "", name = "course", scope = CoursesType.class)
    public JAXBElement<CourseType> createCoursesTypeCourse(CourseType value) {
        return new JAXBElement<CourseType>(_CoursesTypeCourse_QNAME, CourseType.class, CoursesType.class, value);
    }*/
